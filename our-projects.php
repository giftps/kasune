...
<head>
	...
	<title>Projects - The Kasune Project</title>
		...
		<nav class="navbar navbar-expand-md navbar-light">
			<div class="container">
				...
				<div class="navbar-collapse collapse" id="basic-navbar-nav">
					<div class="ms-auto navbar-nav"><a href="#home" data-rr-ui-event-key="#home" class="active navbar-link nav-link">Home</a><a href="#our-story" data-rr-ui-event-key="#our-story" class="navbar-link nav-link">Our Story</a><a href="#our-projects" data-rr-ui-event-key="#our-projects" class="navbar-link nav-link">Our Projects</a><a href="#our-people" data-rr-ui-event-key="#our-people" class="navbar-link nav-link">Our People</a></div><span class="navbar-text"><a href="/tkp/#contact"><button class="vvd"><span>Get in Touch</span></button></a></span>
				</div>
			</div>
		</nav>
						...
						<div>
							<div class="animate__animated animate__fadeIn">
								<div style="display: flex; justify-content: center; align-items: center; text-align: center; padding: 20px;">
									<h1 style="font-size: 10vw; max-width: 100%; white-space: nowrap;"><span style="color: green;">T</span>he<span style="color: green;">K</span>asune<span style="color: green;">P</span>roject</h1>
								</div>
							</div>
						</div>
					</div>
						...
						<div>
							<div class="">
								...
								<ul class="nav nav-pills">
									...
									<li class="nav-item">
										<a class="nav-link" data-bs-toggle="pill" href="#our-projects">Our Projects</a>
									</li>
									<li class="nav-item">
										<a class="nav-link active" data-bs-toggle="pill" href="#our-people">Our People</a>
									</li>
								</ul>

								<!-- Tab panes -->
								<div class="tab-content">
									<div class="tab-pane container fade" id="our-story">
								...
								<!-- //////////////! -->
								<!-- <div class="hidden nav-pills mb-5 justify-content-center align-items-center nav nav-pills" id="pills-tab" role="tablist">
									<div class="nav-item"><a role="tab" data-rr-ui-event-key="first" id="projects-tabs-tab-first" aria-controls="projects-tabs-tabpane-first" aria-selected="true" class="nav-link active" tabindex="0" href="#">Our Story</a></div>
									<div class="nav-item"><a class="nav-link active" data-bs-toggle="pill" id="projects-tabs-tab-second" aria-controls="projects-tabs-tabpane-second" aria-selected="false" tabindex="-1" class="nav-link" href="#">Our Projects</a></div>
									<div class="nav-item"><a role="tab" data-rr-ui-event-key="third" id="projects-tabs-tab-third" aria-controls="projects-tabs-tabpane-third" aria-selected="false" tabindex="-1" class="nav-link" href="#">Our People</a></div>
								</div>
								<div class="tab-content hidden" id="slideInUp">
									<div role="tabpanel" id="projects-tabs-tabpane-first" aria-labelledby="projects-tabs-tab-first" class="fade tab-pane active show">
										<div class="row">
											<div size="12" class="col-md-4 col-sm-6">
												<div class="proj-imgbx"><img>
													<div class="proj-txtx">
														<h4></h4><span></span>
													</div>
												</div>
									...
									<div role="tabpanel" id="projects-tabs-tabpane-first" aria-labelledby="projects-tabs-tab-first" class="fade tab-pane active show">
										<div style="display: flex; justify-content: center; align-items: center; padding: 20px;"><img src="./scr/static/media/project-img1.ebafc1d6e467a3f42bfe.png" style="max-width: 50%; height: auto; border-radius: 60px;"></div>
										<h2>Who We Are</h2>
										<p><span style="color: green;">T</span>he<span style="color: green;">K</span>asune<span style="color: green;">P</span>roject is an organisation whose purpose is to provide funding for equitable access to quality education at identified levels.&nbsp;<span style="color: green;">T</span>he<span style="color: green;">K</span>asune<span style="color: green;">P</span>roject will continuously strive to improve capacity for quality service delivery and mobilise resources to address the critical issues that hinder the youth of Zambia from gaining equitable access to a quality education, be it academic or vocational. Through further education, <span style="color: green;">T</span>he<span style="color: green;">K</span>asune<span style="color: green;">P</span>roject seeks to empower young people realise their full potential as well as strengthen their capacity to achieve sustainable economic levels that break the cycle of poverty.&nbsp;With providing access to further education at its core, the <span style="color: green;">T</span>he<span style="color: green;">K</span>asune<span style="color: green;">P</span>roject takes a holistic approach in its pursuit to empower young people to realise their full potential. The&nbsp;programmes meet recipients at their point of need, dealing with issues that might impact negatively on their personal journeys through education. High on the agenda is self care. There is no question that there can be no success where one’s mental health is in crisis. The work of <span style="color: green;">T</span>he<span style="color: green;">K</span>asune<span style="color: green;">P</span>roject supports and highlights the importance of a robust and resilient mental state, as this is the gateway to any form of success. <span style="color: green;">T</span>he<span style="color: green;">K</span>asune<span style="color: green;">P</span>roject has been running since January 2021.</p>
									</div>
									<div role="tabpanel" id="projects-tabs-tabpane-second" aria-labelledby="projects-tabs-tab-second" class="fade tab-pane">
									...
									<div role="tabpanel" id="projects-tabs-tabpane-third" aria-labelledby="projects-tabs-tab-third" class="fade tab-pane">
										<h2>The Founder:</h2>
										<h2>Ruth Kasune Banda</h2><img src="./scr/static/media/founder-img.11ea5534359432b2f333.png" alt="Header Img" style="display: block; margin-left: auto; margin-right: auto; width: 400px; height: 500px; border-radius: 60px;">
										<p><span style="color: green;">T</span>he<span style="color: green;">K</span>asune<span style="color: green;">P</span>roject is the result of a relentless self challenge of my social responsibilities that started in early 1995, just after my 23 rd &nbsp;birthday. That is a long time to sit on a vision that has such urgency. <span style="color: green;">T</span>he<span style="color: green;">K</span>asune<span style="color: green;">P</span>roject is indeed a labour of love. However, my vision is simple. My call to social action is urgent. My prayer is truly a sincere one: Let us work together, to ensure our youth have equitable access to quality education. Education should never be only for those who can afford it, it should be for everyone who hungers for it. Please join me in my work and with God before us, let us educate the youth of our beloved Zambia!</p>
										<h2>The Inspiration:</h2>
										<h2>Rodwin Chilikwela Kasune</h2><img src="./scr/static/media/inspiration-img.83a1f2493f8bd3ddfca1.png" alt="Header Img" style="display: block; margin-left: auto; margin-right: auto; width: 400px; height: 500px; border-radius: 60px;">
										<p>Rodwin Chilikwela Kasune was my maternal grandfather. He was a wholesome human being who recognised the emancipatory and transformative power of tertiary education. His passion for education has remained with me so many years after his death when I was 11 years old. These charitable works are to honour his life and generosity of spirit and are a monumental mark of his lasting legacy of kindness on my life.</p>
									</div>
								</div> -->
							</div>
				...
				<div class="align-items-center row">
					<div size="12" class="col-md-6">
						<div style="padding: 10px 30px;backgroundcolor:pink!important; margin-right:20px"  class="row col-md-12">
							<div class="col-md-6" style=" backgroundcolor:red!important;color:#fff; font-family: Times, serif;display:auto; left:50;top:50; font-size:2.5em; font-weight:650; padding-top:100px; text-decoration:justify;">
								Educating Our Youth, <br> Advocating for Their Mental Health
							</div>
		...
		<footer class="footer">
			<div class="container">
				<div class="align-items-center row">
					<div class="col-lg-12">
						<div class="newsletter-bx wow slideInUp">
							<div class="text-center">
								...
								<h4>I say to the young people... "When I help you make sense of your life, my life makes sense". That is the reason I am.</h4>
					...
					<div size="12" class="text-center text-sm-end col-sm-6">
						<p>Copyright © 2024 TheKasuneProject</p>
					</div>
				</div>
			</div>
		</footer>
